...
class _ShopFormDialogState extends State<ShopFormDialog> {
  ...
  void initState() {
    ...
    _phone = TextEditingController(text: widget.shop?.phoneNumber);
    _email = TextEditingController(text: widget.shop?.email);
    _tax = TextEditingController(text: widget.shop?.taxNumber);
    _shopType = widget.shop?.shopType ?? ShopType.retailShop;
  ...
  Widget build(BuildContext context) => AlertDialog(
    title: Text(
      context.l10n.text(widget.shop == null ? 'New shop' : 'Edit shop'),
    ),
    content: SizedBox(
      width: 520,
      child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<ShopType>(
                ...
                decoration: InputDecoration(
                  labelText: context.l10n.text('Shop type *'),
                ),
                items: [
                  DropdownMenuItem(
                    value: ShopType.retailShop,
                    child: Text(context.l10n.text('Retail shop')),
                  ),
                  DropdownMenuItem(
                    value: ShopType.wholesaleShop,
                    child: Text(context.l10n.text('Wholesale shop')),
                  ),
                ],
                onChanged: (value) {
                  if (value != null) setState(() => _shopType = value);
                },
              ),
              const SizedBox(height: 12),
              TextFormField(
                ...
                maxLines: 3,
                decoration: InputDecoration(
                  labelText: context.l10n.text('Address'),
                ),
              ),
              const SizedBox(height: 12),
              TextFormField(
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: context.l10n.text('Tax number'),
                ),
              ),
