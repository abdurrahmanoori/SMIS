...
class ProductController extends AsyncNotifier<ProductScreenState> {
  ...
  @override
  Future<ProductScreenState> build() => _load();
  ...
  Future<void> create(ProductDraft draft) async { await _repository.create(draft); await reload(); }
  ...
  Future<ProductScreenState> _load({ProductSyncResult? lastSyncResult}) async => ProductScreenState(
