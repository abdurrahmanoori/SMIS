...
namespace SMIS.Infrastructure.Server.Repositories.ProductUnits
{
    public class ProductUnitRepository : GenericRepository<ProductUnit>, IProductUnitRepository
    {
        ...
        public Task<ProductUnit?> GetByIdIncludingDeletedAsync(
            string id,
        ...
        {
            // Once a ProductUnit appears in pricing or inventory history, changing its
            // conversion would reinterpret historical quantities, so it becomes locked.
