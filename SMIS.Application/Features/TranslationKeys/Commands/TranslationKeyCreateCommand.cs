...
{
    public record TranslationKeyCreateCommand(TranslationKeyCreateDto TranslationKeyCreateDto)
        : IRequest<Result<TranslationKeyDto>>;

    internal sealed class
        TranslationKeyCreateCommandHandler : IRequestHandler<TranslationKeyCreateCommand, Result<TranslationKeyDto>>
    {
        private readonly ITranslationKeyRepository _translationKeyRepository;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public TranslationKeyCreateCommandHandler(
        ...
        public async Task<Result<TranslationKeyDto>> Handle(
            TranslationKeyCreateCommand request,
