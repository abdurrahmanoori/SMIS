...
namespace SMIS.Application.Features.TranslationKeys.Commands
{
    ...
    internal sealed class
        TranslationKeyDeleteCommandHandler : IRequestHandler<TranslationKeyDeleteCommand, Result<Unit>>
    {
        private readonly ITranslationKeyRepository _translationKeyRepository;
        private readonly IUnitOfWork _unitOfWork;

        public TranslationKeyDeleteCommandHandler(
        ...
        public async Task<Result<Unit>> Handle(
            TranslationKeyDeleteCommand request,
