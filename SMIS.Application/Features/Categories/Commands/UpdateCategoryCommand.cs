...
{
    public record UpdateCategoryCommand(string Id, CategoryCreateDto CategoryCreateDto) : IRequest<Result<CategoryDto>>;
    ...
    internal sealed class UpdateCategoryCommandHandler : IRequestHandler<UpdateCategoryCommand, Result<CategoryDto>>
    {
        ...
        public UpdateCategoryCommandHandler(IUnitOfWork unitOfWork, IMapper mapper, ICategoryRepository categoryRepository, ITranslationKeyRepository translationKeyRepository)
        {
