...
{
    public record ProductUnitGetListQuery(
        int PageNumber = 1,
        int PageSize = 25,
        bool IncludeProduct = false,
        bool IncludeUnitOfMeasure = false
    ) : IRequest<Result<PagedList<ProductUnitDto>>>;

    internal sealed class
        ProductUnitGetListQueryHandler : IRequestHandler<ProductUnitGetListQuery, Result<PagedList<ProductUnitDto>>>
    {
        private readonly IProductUnitRepository _productUnitRepository;
        private readonly IMapper _mapper;

        public ProductUnitGetListQueryHandler(
        ...
        public async Task<Result<PagedList<ProductUnitDto>>> Handle(
            ProductUnitGetListQuery request,
        ...
        )
        {
            ...
            var query = _productUnitRepository.GetAllQueryable(
