...
{
    public record UpdateProductCommand(string Id, ProductCreateDto ProductCreateDto) : IRequest<Result<ProductDto>>;
    ...
    internal sealed class UpdateProductCommandHandler : IRequestHandler<UpdateProductCommand, Result<ProductDto>>
    {
        ...
        public UpdateProductCommandHandler(IUnitOfWork unitOfWork, IMapper mapper, IProductRepository productRepository, ITranslationKeyRepository translationKeyRepository)
        {
