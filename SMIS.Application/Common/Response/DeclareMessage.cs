namespace SMIS.Application.Common.Response
{
    public class DeclareMessage
    {
        ...
        public static ValidationError InvalidOperation = new()
            { Code = nameof(InvalidOperation), Description = "This operation is not valid." };
        ...
        public static ValidationError Duplicate = new()
            { Code = nameof(Duplicate), Description = "The item is already exists" };
